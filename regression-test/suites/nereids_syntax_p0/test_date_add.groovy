...
suite("test_date_add") {
    ...
    qt_sql """ SELECT DATE_ADD('2020-01-01 00:00:00.000000', INTERVAL 2 MICROSECOND); """
    qt_sql """ SELECT DATE_ADD('2020-01-01 00:00:00', INTERVAL 1 QUARTER); """
    qt_sql """ SELECT DATE_ADD('2020-01-01 00:00:00', INTERVAL '1.500000' SECOND_MICROSECOND); """
    qt_sql """ SELECT DATE_ADD('2020-01-01 00:00:00', INTERVAL '1:30' MINUTE_SECOND); """
    qt_sql """ SELECT DATE_ADD('2020-01-01 00:00:00', INTERVAL '1:2:3.004005' HOUR_MICROSECOND); """
    qt_sql """ SELECT DATE_ADD('2020-01-01 00:00:00', INTERVAL '2 03:04:05' DAY_SECOND); """
    qt_sql """ SELECT DATE_ADD('2020-01-01 00:00:00', INTERVAL '1-2' YEAR_MONTH); """
}    
