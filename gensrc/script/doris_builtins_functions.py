...
visible_functions = {
    ...
    "Timestamp": [
        ...
        [['second_microsecond_add'], 'DATETIME', ['DATETIME', 'VARCHAR'], 'ALWAYS_NULLABLE'],
        [['second_microsecond_sub'], 'DATETIME', ['DATETIME', 'VARCHAR'], 'ALWAYS_NULLABLE'],
        [['minute_microsecond_add'], 'DATETIME', ['DATETIME', 'VARCHAR'], 'ALWAYS_NULLABLE'],
        [['minute_microsecond_sub'], 'DATETIME', ['DATETIME', 'VARCHAR'], 'ALWAYS_NULLABLE'],
        [['minute_second_add'], 'DATETIME', ['DATETIME', 'VARCHAR'], 'ALWAYS_NULLABLE'],
        [['minute_second_sub'], 'DATETIME', ['DATETIME', 'VARCHAR'], 'ALWAYS_NULLABLE'],
        [['hour_microsecond_add'], 'DATETIME', ['DATETIME', 'VARCHAR'], 'ALWAYS_NULLABLE'],
        [['hour_microsecond_sub'], 'DATETIME', ['DATETIME', 'VARCHAR'], 'ALWAYS_NULLABLE'],
        [['hour_second_add'], 'DATETIME', ['DATETIME', 'VARCHAR'], 'ALWAYS_NULLABLE'],
        [['hour_second_sub'], 'DATETIME', ['DATETIME', 'VARCHAR'], 'ALWAYS_NULLABLE'],
        [['hour_minute_add'], 'DATETIME', ['DATETIME', 'VARCHAR'], 'ALWAYS_NULLABLE'],
        [['hour_minute_sub'], 'DATETIME', ['DATETIME', 'VARCHAR'], 'ALWAYS_NULLABLE'],
        [['day_microsecond_add'], 'DATETIME', ['DATETIME', 'VARCHAR'], 'ALWAYS_NULLABLE'],
        [['day_microsecond_sub'], 'DATETIME', ['DATETIME', 'VARCHAR'], 'ALWAYS_NULLABLE'],
        [['day_second_add'], 'DATETIME', ['DATETIME', 'VARCHAR'], 'ALWAYS_NULLABLE'],
        [['day_second_sub'], 'DATETIME', ['DATETIME', 'VARCHAR'], 'ALWAYS_NULLABLE'],
        [['day_minute_add'], 'DATETIME', ['DATETIME', 'VARCHAR'], 'ALWAYS_NULLABLE'],
        [['day_minute_sub'], 'DATETIME', ['DATETIME', 'VARCHAR'], 'ALWAYS_NULLABLE'],
        [['day_hour_add'], 'DATETIME', ['DATETIME', 'VARCHAR'], 'ALWAYS_NULLABLE'],
        [['day_hour_sub'], 'DATETIME', ['DATETIME', 'VARCHAR'], 'ALWAYS_NULLABLE'],
        [['year_month_add'], 'DATETIME', ['DATETIME', 'VARCHAR'], 'ALWAYS_NULLABLE'],
        [['year_month_sub'], 'DATETIME', ['DATETIME', 'VARCHAR'], 'ALWAYS_NULLABLE'],
        ...
        [['second_microsecond_add'], 'DATETIMEV2', ['DATETIMEV2', 'VARCHAR'], ''],
        [['second_microsecond_sub'], 'DATETIMEV2', ['DATETIMEV2', 'VARCHAR'], ''],
        [['minute_microsecond_add'], 'DATETIMEV2', ['DATETIMEV2', 'VARCHAR'], ''],
        [['minute_microsecond_sub'], 'DATETIMEV2', ['DATETIMEV2', 'VARCHAR'], ''],
        [['minute_second_add'], 'DATETIMEV2', ['DATETIMEV2', 'VARCHAR'], ''],
        [['minute_second_sub'], 'DATETIMEV2', ['DATETIMEV2', 'VARCHAR'], ''],
        [['hour_microsecond_add'], 'DATETIMEV2', ['DATETIMEV2', 'VARCHAR'], ''],
        [['hour_microsecond_sub'], 'DATETIMEV2', ['DATETIMEV2', 'VARCHAR'], ''],
        [['hour_second_add'], 'DATETIMEV2', ['DATETIMEV2', 'VARCHAR'], ''],
        [['hour_second_sub'], 'DATETIMEV2', ['DATETIMEV2', 'VARCHAR'], ''],
        [['hour_minute_add'], 'DATETIMEV2', ['DATETIMEV2', 'VARCHAR'], ''],
        [['hour_minute_sub'], 'DATETIMEV2', ['DATETIMEV2', 'VARCHAR'], ''],
        [['day_microsecond_add'], 'DATETIMEV2', ['DATETIMEV2', 'VARCHAR'], ''],
        [['day_microsecond_sub'], 'DATETIMEV2', ['DATETIMEV2', 'VARCHAR'], ''],
        [['day_second_add'], 'DATETIMEV2', ['DATETIMEV2', 'VARCHAR'], ''],
        [['day_second_sub'], 'DATETIMEV2', ['DATETIMEV2', 'VARCHAR'], ''],
        [['day_minute_add'], 'DATETIMEV2', ['DATETIMEV2', 'VARCHAR'], ''],
        [['day_minute_sub'], 'DATETIMEV2', ['DATETIMEV2', 'VARCHAR'], ''],
        [['day_hour_add'], 'DATETIMEV2', ['DATETIMEV2', 'VARCHAR'], ''],
        [['day_hour_sub'], 'DATETIMEV2', ['DATETIMEV2', 'VARCHAR'], ''],
        [['year_month_add'], 'DATETIMEV2', ['DATETIMEV2', 'VARCHAR'], ''],
        [['year_month_sub'], 'DATETIMEV2', ['DATETIMEV2', 'VARCHAR'], ''],
        ...
        [['second_microsecond_add'], 'DATETIMEV2', ['DATEV2', 'VARCHAR'], ''],
        [['second_microsecond_sub'], 'DATETIMEV2', ['DATEV2', 'VARCHAR'], ''],
        [['minute_microsecond_add'], 'DATETIMEV2', ['DATEV2', 'VARCHAR'], ''],
        [['minute_microsecond_sub'], 'DATETIMEV2', ['DATEV2', 'VARCHAR'], ''],
        [['minute_second_add'], 'DATETIMEV2', ['DATEV2', 'VARCHAR'], ''],
        [['minute_second_sub'], 'DATETIMEV2', ['DATEV2', 'VARCHAR'], ''],
        [['hour_microsecond_add'], 'DATETIMEV2', ['DATEV2', 'VARCHAR'], ''],
        [['hour_microsecond_sub'], 'DATETIMEV2', ['DATEV2', 'VARCHAR'], ''],
        [['hour_second_add'], 'DATETIMEV2', ['DATEV2', 'VARCHAR'], ''],
        [['hour_second_sub'], 'DATETIMEV2', ['DATEV2', 'VARCHAR'], ''],
        [['hour_minute_add'], 'DATETIMEV2', ['DATEV2', 'VARCHAR'], ''],
        [['hour_minute_sub'], 'DATETIMEV2', ['DATEV2', 'VARCHAR'], ''],
        [['day_microsecond_add'], 'DATETIMEV2', ['DATEV2', 'VARCHAR'], ''],
        [['day_microsecond_sub'], 'DATETIMEV2', ['DATEV2', 'VARCHAR'], ''],
        [['day_second_add'], 'DATETIMEV2', ['DATEV2', 'VARCHAR'], ''],
        [['day_second_sub'], 'DATETIMEV2', ['DATEV2', 'VARCHAR'], ''],
        [['day_minute_add'], 'DATETIMEV2', ['DATEV2', 'VARCHAR'], ''],
        [['day_minute_sub'], 'DATETIMEV2', ['DATEV2', 'VARCHAR'], ''],
        [['day_hour_add'], 'DATETIMEV2', ['DATEV2', 'VARCHAR'], ''],
        [['day_hour_sub'], 'DATETIMEV2', ['DATEV2', 'VARCHAR'], ''],
        [['year_month_add'], 'DATETIMEV2', ['DATEV2', 'VARCHAR'], ''],
        [['year_month_sub'], 'DATETIMEV2', ['DATEV2', 'VARCHAR'], ''],
